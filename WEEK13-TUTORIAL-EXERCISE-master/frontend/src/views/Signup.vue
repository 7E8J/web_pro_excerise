      ...
      <div class="column is-4">
        ...
        <div class="field">
          ...
          <template v-if="$v.username.$error">
            ...
            <p class="help is-danger" v-if="!$v.username.minLength">Must be at least 5 characters</p>
          </template>
        </div>
        ...
        <div class="field">
          ...
          <template v-if="$v.password.$error">
            ...
            <p class="help is-danger" v-if="!$v.password.minLength">Must be at least 8 characters</p>
            <p class="help is-danger" v-if="!$v.password.complex">Password to easy</p>
          </template>
        </div>
        ...
        <div class="field">
          ...
          <template v-if="$v.confirm_password.$error">
            <p class="help is-danger" v-if="!$v.confirm_password.sameAs">Password not match</p>
          </template>
        </div>
